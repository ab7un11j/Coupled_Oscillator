...
class Couple_Occ:
    ...
    def draw_Cople_Occ(self,win):
        ...
        pg.draw.line(win,(60,180,160),self.movpos1,self.movpos2, 4)
        
        pg.draw.circle(win, (0,0,0),self.movpos1,9)
        pg.draw.circle(win, (0,0,0),self.movpos2,9)
    ...
    def draw_ini_wp(self,win):
        ...
        pg.draw.circle(win,C1,(self.m1.pos[0],self.m1.pos[1]+d),3)
        pg.draw.circle(win,C1,(self.m2.pos[0],self.m2.pos[1]+d),3)
        pg.draw.circle(win,C1,(self.m1.pos[0],self.m1.pos[1]-d),3)
        pg.draw.circle(win,C1,(self.m2.pos[0],self.m2.pos[1]-d),3)
        
        #drawing Hoizontal spring
        pg.draw.line(win,'red',(self.m1.pos[0],self.m1.pos[1]+d), self.movpos1,3)
        pg.draw.line(win,'red',(self.m2.pos[0],self.m2.pos[1]+d), self.movpos2,3)
        pg.draw.line(win,'red',(self.m1.pos[0],self.m1.pos[1]-d), self.movpos1,3)
        pg.draw.line(win,'red',(self.m2.pos[0],self.m2.pos[1]-d), self.movpos2,3)
